...
const api = useApi()
const { data: days } = await useAsyncData('program-days', () => api.get<ProgramDay[]>('/api/program/days'))
...
.picker {
  width: 100%; min-height: 48px; margin-bottom: 16px;
